			...
			<div class="subnavbar-inner">
				<div class="container">
					<ul class="mainnav">
						...
						<li <?php echo $usershow; ?> class="active"><a href="javascript:void(0);"
						...
						<div class="span12">
							<div class="box box-widget widget-user profile-gradient">
								<div style="text-align: center;">
									<div class="widget-user-header bg-profile"></div>
								</div>
								<div id="targetDpLayer" class="widget-user-image hand targetDpLayer"
									pd-popup-open="changeDp">
									<?php echo $user_pic; ?>
								</div>
								<div class="banner-user text-center" style="padding-bottom: 0px;">
									<h2 class="profile-user text-center"><?php echo $firstname;
									echo $lastname; ?></h2>
						...
						<div class="span12">
							<div class="widget widget-nopad">
								<div class="widget-header"> <i class="fa fa-user"></i>&nbsp;
									<h3>Bio</h3>
									<div style="float:right;margin-right: 5px;"><button <?php echo $addBtn; ?>
											class="btn btn-primary btn-small" pd-popup-open="addbio">Add / Edit</button>
									</div>
								</div>
										...
										<div class="widget-content">
											<div class="big_stats cf">
												<div class="profile_widgets">
													<div class="user_bio"
														style="padding: 0px 10px 10px 10px;font-size: 14px;">
														<?php echo $seeker_bio; ?>
													</div>
												</div>
											</div>
						...
						<div class="span12">
							<div class="widget widget-nopad">
								<div class="widget-header"> <i class="fa fa-gavel"></i>&nbsp;
									<h3>Skills</h3>
									<div style="float:right;margin-right: 5px;"><button <?php echo $addBtn; ?>
											class="btn btn-small" pd-popup-open="addskill">Add / Edit</button></div>
								</div>
								<div class="widget-content">
									<div class="widget big-stats-container">
										<div class="widget-content">
											<div class="big_stats cf">
												<div class="profile_widgets">
													...
													<div class="text-center"><a href="javascript:void(0)"
															pd-popup-open="v_allskills">View all</a></div>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="span12">
							<div class="widget widget-nopad">
								<div class="widget-header"> <i class="fa fa-mortar-board"></i>&nbsp;
									<h3>Education</h3>
									<div style="float:right;margin-right: 10px;"><button <?php echo $addBtn; ?>
											class="btn btn-small" pd-popup-open="addeducation"> Add</button></div>
								</div>
								<div class="widget-content">
									<div class="widget big-stats-container">
										<div class="widget-content">
						...
						<div class="span12">
							<div class="widget widget-nopad">
								<div class="widget-header"> <i class="fa fa-suitcase"></i>&nbsp;
									<h3>Experience</h3>
									<div style="float:right;margin-right: 10px;"><button <?php echo $addBtn; ?>
											class="btn btn-small" pd-popup-open="addxp">Add</button></div>
								</div>
								<div class="widget-content">
									<div class="widget big-stats-container">
										<div class="widget-content">
						...
						<div class="span12">
							<div class="widget widget-nopad">
								<div class="widget-header"> <i class="fa fa-file"></i> &nbsp;
									<h3>CV Reference</h3>
									<div style="float:right;margin-right: 10px;"><button <?php echo $addBtn; ?>
											class="btn btn-small btn-success" pd-popup-open="addcv">Add/ Replace CV</button></div>
								</div>
								<div class="widget-content">
									<div class="widget big-stats-container">
										<div class="widget-content">
