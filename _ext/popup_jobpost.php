						  ...
						  <div class="control-group">											
						    ...
						    <div class="controls">
							  <select name="region" id="region">
							    <option value="" Selected disabled></option>
								<option value="Province1">Province No.1</option><option value="Madhesh">Madhesh Pradesh</option><option value="Bagmati">Bagmati Province</option>
								<option value="Karnali">Karnali Pradesh</option><option value="Gandaki">Gandaki Province</option><option value="Lumbini">Lumbini Province</option>
								<option value="Sudurpaschim">Sudurpaschim Pradesh</option>
							  </select> 
						    </div>		
						  </div>
						  <div class="control-group">											
						    ...
						    <div class="controls">
							  <select name="deadline" id="deadline">
								...
								<option value="10 days">10 days</option><option value="12 days">12 days</option>
								<option value="14 days">14 days</option><option value="16 days">16 days</option>
								<option value="20 days">20 days</option><option value="1 month">1 month</option>
