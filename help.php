...
<head>
<meta charset="utf-8">
<title>TalentTaps Support</title>
	    ...
	    <div class="span12">
	      <div class="widget">
			...
			<div class="widget-content">
			  <ol class="faq-list">
				<li>
				  <h4>What is TalentTaps? How does the system work?</h4>
				  ...
				  <p>TalentTaps is a job searching website that automates the screening and shortlisting processes of recruitment. 
				...
				<li>
				  <h4>Who is behind TalentTaps?</h4>
				  <p> TalentTaps is a privately held company with global ambitions and consists of a well seasoned
				  management team and advisors. Prashant Chaudhary being the leader of the project team founded this company.</p>	
				</li>
				<li>
				  <h4> Is TalentTaps a recruitment firm?</h4>
				  <p> No. TalentTaps is NOT a recruitment agency. We do not do candidate interviewing but automate short-listing. 
				...
				<li>
				  <h4>Do I need a PC before i can visit www.talenttaps.com?</h4>
				  <p> No. You can also access www.talenttaps.com on your mobile phone. But we strong recommend a PC, just to enhance your experience on the website.</p>	
				</li>
				<li>
				  <h4>What happens when I apply online for jobs posted on www.talenttaps.com?</h4>
	  ...
	  <div class="row" style="margin-top:5px">
	    <div class="span12">
	      <div class="widget">
			...
			<div class="widget-content">
			  <ul>
				<li><h4><a href="index.php">Front page</a></h4></li>
